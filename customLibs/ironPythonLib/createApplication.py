...
url = "https://s3-eu-west-1.amazonaws.com/asset-market-place-sources/customLibs/NamOsMarketPlace/application/applicationMenu.html"
urlReference = UrlReference ( name, url, None, ContentType.HTML,False )
cr[name]= urlReference
