...
function renderCore(sfdata){
  ...
  var myEvents = [];
	...
	for (var i=0;i<originalEvents.length;i++) {
		...
		curEventValue.content = '<div>' + curEvent[3] +'</div><img  onerror="this.style.display=' + "'none'" + '" src="http://localhost:8888/jsviz/src/namos/visTimeline/images/' + curEvent[2] + '.png" style="width:48px; height:48px;">';
